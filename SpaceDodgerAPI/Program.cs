...
builder.Services.AddSwaggerGen(c =>
{
    ...
    { 
        Title = "Space Dodger API", 
        Version = "v1",
        Description = "RESTful API for Space Dodger Game with JWT Authentication"
    });
...
var jwtIssuer = builder.Configuration["Jwt:Issuer"] ?? "SpaceDodgerAPI";
var jwtAudience = builder.Configuration["Jwt:Audience"] ?? "SpaceDodgerClient";
